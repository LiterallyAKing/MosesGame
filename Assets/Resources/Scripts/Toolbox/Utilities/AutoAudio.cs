...
Simply right click on an audio file / audio files then choose "AutoAudio Check". Results of the check will be printed to the console. You can also have it run on all audio files automatically on import. Enable this by going to Preferences->AutoAudio & select "Automatically Run on Import".
	*/

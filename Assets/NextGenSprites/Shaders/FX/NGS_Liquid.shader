	...
	SubShader {
		...
		Pass {
			...
			float4 frag(VertexOutput i) : COLOR {
				...
				half Colorcombined = (lerp(_FirstTex.a, _SecondTex.a, UVLerpController) * _Color.a * i.vertexColor.a);
				half3 diffuseColor = ((DiffuseCurrent * _Color.rgb * i.vertexColor.rgb) * Colorcombined);
